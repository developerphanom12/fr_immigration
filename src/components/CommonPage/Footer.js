          ...
          <div className="row">
            <div className="col-lg-3">
              <div className="iot111er">
                <img
                  src={logo3}
                  alt="dfdffd"
                  className="img-fluid imgf1ooter"
                />
                <p className="paragraph1">
                  The Phanom platform is the ultimate solution for Institutions
                  and Recruitment partners alike to unlock global access, gain
                  awareness and achieve strategic objectives
                </p>
            ...
            <div className="col-lg-3">
              <div className="headofice1">
                <h1 className="h1gfooter ">Head Office</h1>

                <p className="mt-1 p1ofo">
                  {" "}
                ...
                <div className="flagbox22">
                  ...
                  <div className="contact-location ">
                    <a className="afooter  " href="mailto:info@crizac.co.uk">
                      info@Phanom.co.uk
                    </a>
                  </div>
                </div>
                <div className="flagbox22">
                  ...
                  <div className="contact-location ">
                    <a className="afooter  " href="phoneno:+44 2475 280303">
                      +44 2475 280303
                    </a>
                  </div>
                </div>
            ...
            <div className="col-lg-2 ">
              <div className="headofice1">
                <h1 className="h1gfooter">Become A Partner</h1>
                <button
                  className="btn12button mt-2"
                  onClick={() => {
                    navigate("/login");
                  }}
                >
                ...
                <div className="p_tag">
                  <div className=" flagfooter">
                    <img
                      src={google}
                      alt="img"
                      className="img-fluid img-foter1"
                    />
                  </div>
                  <div className=" flagfooter">
                    <img
          ...
          <div className="row align-items-center text-lg-left text-center">
            <div className="col-lg-6 hfh mb-lg-0 mb-2">
              <div className="hfh mt-2">
                <p className="hhh12121212112">
                  &copy; {new Date().getFullYear()} Phanom Professional
                </p>
              </div>
            </div>
