...
//     try {
//       const res = await axios.post(`${EXCHANGE_URLS}/login`, logindata)
...
//           </div>
//           <div className='user_name'>
//             <input type='Password' onChange={(e) => { setlogindata({ ...logindata, password: e.target.value }) }} placeholder='Password' />
          // </div>
          // <div>
